...
def main():
    ...
    # ("country ; city", 2017 summer mean temperature)
    summer_mean_temp = mean_temperature(season, city_keys, header_position, '^2017-0[6-9]-...1[2-5]')
    ...
    # ("country ; city", 2017 winter mean temperature)
    winter_mean_temp = mean_temperature(season, city_keys, header_position, '^2017-0[1-4]-...1[2-5]')
    ...
    # ("country ; city", 2016 summer mean temperature)
    summer_mean_temp = mean_temperature(season, city_keys, header_position, '^2016-0[6-9]-...1[2-5]')
    ...
    # ("country ; city", 2017 winter mean temperature)
    winter_mean_temp = mean_temperature(season, city_keys, header_position, '^2016-0[1-4]-...1[2-5]')
    ...
    for country in countries:
        ...
        temp_chart = temp_chart_rdd.takeOrdered(3, lambda x: -x[1][0])
